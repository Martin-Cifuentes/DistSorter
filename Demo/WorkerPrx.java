...
public interface WorkerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        processTask(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void processTask(java.util.Map<String, String> context)
    {
        _iceI_processTaskAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> processTaskAsync()
    {
        return _iceI_processTaskAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> processTaskAsync(java.util.Map<String, String> context)
    {
        return _iceI_processTaskAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_processTaskAsync(java.util.Map<String, String> context, boolean sync)
    {
